...
public:
  ...
  void setup(CamView3d& view, double width, double height);
  void setup(SideView3d& view, double width, double height);
  void setup(TopView3d& view, double width, double height);
  void setup(TrajView& view, double width, double height);
