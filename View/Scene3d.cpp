...
Scene3d::Scene3d() :
  ...
  setRotation(-180.0 * M_PI / 180.0, -45.0 * M_PI / 180.0, 0.0);
  setScale(1.0);
}
...
void Scene3d::setup(CamView3d& view) {
  glMatrixMode(GL_MODELVIEW);
  glScalef(mScale, mScale, mScale);
  glRotatef(mRotation[2] * 180.0 / M_PI, 1, 0, 0);
  glRotatef(mRotation[1] * 180.0 / M_PI, 0, 1, 0);
...
void Scene3d::render(CamView3d& view) {
  emit render(view, *this);
}



void Scene3d::setup(SideView3d& view) {
  glMatrixMode(GL_MODELVIEW);
  glScalef(mScale, mScale, mScale);
  glRotatef(mRotation[2] * 180.0 / M_PI, 1, 0, 0);
  glRotatef(mRotation[1] * 180.0 / M_PI, 0, 1, 0);
...
void Scene3d::render(SideView3d& view) {
  emit render(view, *this);
}


void Scene3d::setup(TrajView& view) {
  glMatrixMode(GL_MODELVIEW);
  glScalef(mScale, mScale, mScale);
  glRotatef(mRotation[2] * 180.0 / M_PI, 1, 0, 0);
  glRotatef(mRotation[1] * 180.0 / M_PI, 0, 1, 0);
...
void Scene3d::render(TrajView& view) {
  emit render(view, *this);
}


void Scene3d::setup(TopView3d& view) {
  glMatrixMode(GL_MODELVIEW);
  glScalef(mScale, mScale, mScale);
  glRotatef(mRotation[2] * 180.0 / M_PI, 1, 0, 0);
  glRotatef(mRotation[1] * 180.0 / M_PI, 0, 1, 0);
...
void Scene3d::render(TopView3d& view) {
  emit render(view, *this);
}
