...
SideView3d::SideView3d(QWidget* parent) :
  ...
  connect(&SideView3d::getInstance().getScene(), SIGNAL(render(SideView3d&, Scene3d&)),this, SLOT(render(SideView3d&, Scene3d&)));
  setBackgroundColor(Qt::white);
  }

SideView3d::~SideView3d() {
  if (mFont)
    delete mFont;
}
...
Camera& SideView3d::getCamera() {
  return mCamera;
}

const Camera& SideView3d::getCamera() const {
  return mCamera;
}

Scene3d& SideView3d::getScene() {
  return mScene;
}

const Scene3d& SideView3d::getScene() const {
  return mScene;
}

void SideView3d::setColor(const QColor& color) {
  glColor4f(color.redF(), color.greenF(), color.blueF(), color.alphaF());
}

void SideView3d::setColor(const Palette& palette, const QString& role) {
  setColor(palette.getColor(role));
}

void SideView3d::setFont(const QString& filename) {
...
const QString& SideView3d::getFont() const {
  return mFontFilename;
}


void SideView3d::setBackgroundColor(const QColor& color) {
...
std::vector<double> SideView3d::unproject(const QPoint& point, double distance) {
...
void SideView3d::render(double x, double y, double z, const QString& text,
...
void SideView3d::mousePressEvent(QMouseEvent* event) {
  mMouse[0] = event->globalX();
  mMouse[1] = event->globalY();
}

void SideView3d::mouseMoveEvent(QMouseEvent* event) {
...
void SideView3d::resizeGL(int width, int height) {
  glViewport(0, 0, width, height);
  mCamera.setup(*this, width, height);
}

void SideView3d::paintGL() {
...
void SideView3d::paintEvent(QPaintEvent* event) {
  QOpenGLWidget::paintEvent(event);
  emit updated();
}

void SideView3d::cameraPositionChanged(const std::vector<double>& position) {
  update();
}

void SideView3d::cameraViewpointChanged(const std::vector<double>& viewpoint) {
  update();
}

void SideView3d::cameraRangeChanged(const std::vector<double>& range) {
  update();
}

void SideView3d::sceneTranslationChanged(const std::vector<double>& translation) {
  update();
}

void SideView3d::sceneRotationChanged(const std::vector<double>& rotation) {
  update();
}

void SideView3d::sceneScaleChanged(double scale) {
  update();
}

void SideView3d::resizeEvent(QResizeEvent* event) {
  QOpenGLWidget::resizeEvent(event);
  emit resized();
}


void SideView3d::renderBackground() {
...
void SideView3d::render(SideView3d& view, Scene3d& Scene3d) {
     renderBackground();
}
